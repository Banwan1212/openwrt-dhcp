...
CONFIG_PACKAGE_apache-icons=m
CONFIG_PACKAGE_appweb=m
CONFIG_PACKAGE_axhttpd=m
CONFIG_PACKAGE_axtlswrap=m
CONFIG_PACKAGE_crowdcontrol=m
CONFIG_PACKAGE_dansguardian=m
CONFIG_PACKAGE_haproxy=m
CONFIG_PACKAGE_hiawatha=m
...
CONFIG_PACKAGE_lighttpd-mod-cml=m
CONFIG_PACKAGE_lighttpd-mod-compress=m
...
CONFIG_PACKAGE_lighttpd-mod-flv-streaming=m
...
CONFIG_PACKAGE_lighttpd-mod-simple-vhost=m
CONFIG_PACKAGE_lighttpd-mod-ssi=m
CONFIG_PACKAGE_lighttpd-mod-status=m
CONFIG_PACKAGE_lighttpd-mod-trigger-b4-dl=m
